...
!function(t, n) {
	...
	function s(t, n, e) {
		...
		if (u(t)) {
			for (var o in t)
				if (a(t, o) && n.call(i, t[o], o) === !1)
					break
			}
		else if (r(t))
			for (var l = 0; l < t.length && n.call(i, t[l], l) !== !1; l++)
			;
			return t
	}
	function c(t) {
		for (var n = arguments.length, e = Array(n > 1
			? n - 1
			: 0), i = 1; i < n; i++)
			e[i - 1] = arguments[i];
	...
	function S(t) {
		for (var n = arguments.length > 1 && void 0 !== arguments[1]
			? arguments[1]
			: "y", e = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2], i = Lt[n], o = t instanceof Element
			? [t]
			: d(t), r = [], l = xt.createElement("div"), u = 0; u < o.length; u++) {
			var a = o[u];
			if (a[i] > 0
				? r.push(a)
				: (l.style.width = a.clientWidth + 1 + "px", l.style.height = a.clientHeight + 1 + "px", a.appendChild(l), a[i] = 1.5 / y(), a[i] > 0 && r.push(a), a[i] = 0, a.removeChild(l)), !e && r.length > 0)
				break
		}
		return r
	}
	...
	function Z(t, n, e, i, o) {
		...
		return 0 === n
			...
			: 1 === (n /= o)
				...
				: (l || (l = .3 * o), u < ht(i)
					? (u = i, r = l / 4)
					: r = l / (2 * dt) * pt(i / u), -(u * ct(2, 10 * (n -= 1)) * st((n * o - r) * (2 * dt) / l)) + e)
	}
	function tt(t, n, e, i, o) {
		...
		return 0 === n
			...
			: 1 === (n /= o)
				...
				: (l || (l = .3 * o), u < ht(i)
					? (u = i, r = l / 4)
					: r = l / (2 * dt) * pt(i / u), u * ct(2, -10 * n) * st((n * o - r) * (2 * dt) / l) + i + e)
	}
		...
		return 0 === n
			...
			: 2 === (n /= o / 2)
				...
				: (l || (l = o * (.3 * 1.5)), u < ht(i)
					? (u = i, r = l / 4)
					: r = l / (2 * dt) * pt(i / u), n < 1
					? -.5 * (u * ct(2, 10 * (n -= 1)) * st((n * o - r) * (2 * dt) / l)) + e
					: u * ct(2, -10 * (n -= 1)) * st((n * o - r) * (2 * dt) / l) * .5 + i + e)
	}
	...
	function rt(t, n, e, i, o) {
		return (n /= o) < 1 / 2.75
			? i * (7.5625 * n * n) + e
			: n < 2 / 2.75
				? i * (7.5625 * (n -= 1.5 / 2.75) * n + .75) + e
				: n < 2.5 / 2.75
					? i * (7.5625 * (n -= 2.25 / 2.75) * n + .9375) + e
					: i * (7.5625 * (n -= 2.625 / 2.75) * n + .984375) + e
	}
	...
	var at = Math.cos,
		...
		gt = Math.min,
		yt = Math.round,
		St = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
			? function(t) {
				return typeof t
			}
			: function(t) {
	...
	var Ot = !("undefined" == typeof window || !window.document || !window.document.createElement),
		It = function() {
			...
			return (t.indexOf("Android 2.") === -1 && t.indexOf("Android 4.0") === -1 || t.indexOf("Mobile Safari") === -1 || t.indexOf("Chrome") !== -1 || t.indexOf("Windows Phone") !== -1) && (window.history && "pushState" in window.history && "file:" !== window.location.protocol)
		}(),
		_t = Ot
			? window
			: null,
		...
		Tt = Ot
			...
			: null,
		zt = Ot
			? _t.cancelAnimationFrame
			: null;
	if (Ot) {
		for (var qt = 0; qt < Mt.length && !Tt; ++qt)
			Tt = _t[Mt[qt] + "RequestAnimationFrame"],
			zt = _t[Mt[qt] + "CancelAnimationFrame"] || _t[Mt[qt] + "CancelRequestAnimationFrame"];
		Tt || (Tt = function(t) {
			var n = Date.now(),
				e = vt(0, 16 - (n - Rt)),
	...
	var Dt = function() {
			...
			return kt(t, [
				{
					...
					value: function(t, n, e) {
						...
						this.progress || (this.props = {
							x: t,
							y: n
						}, this.options = e, this.easing = i(e.easing)
							? e.easing
							: At[e.easing.replace("ease", "")], this.progress = !0, setTimeout(function() {
					...
					value: function() {
						...
						this.progress = !1,
						zt(this.rafId),
						t && (x(this.el, this.props.x, "x"), x(this.el, this.props.y, "y")),
					...
					value: function(t) {
						...
						f <= a
							? (c.call(this, p, h), this.rafId = Tt(function(t) {
								return n._loop(t)
							}))
							: this.stop(!0)
					}
					...
					value: function(t, n) {
						...
						if (this.options.quickMode) {
							var i = I(this.el),
								...
								r = o.width,
								l = o.height;
							ht(e.y - n) > l && (e.y = e.y > n
								? n + l
								: n - l),
							ht(e.x - t) > r && (e.x = e.x > t
								? t + r
								: t - r)
						}
						return e
		...
		Wt = function() {
			function t() {
				...
				null == this.container
					? (this.header = null, this.tween = null, this.isSSR || (/comp|inter|loaded/.test(xt.readyState)
						? this.log('Not found scrollable container. => "' + e + '"')
						: this.log("Should be initialize later than DOMContentLoaded.")))
					: (this.header = p(this.options.header), this.tween = new Dt(this.container), this._trigger = null, this._shouldCallCancelScroll = !1, this.bindContainerClick())
			}
			return kt(t, [
				{
					key: "log",
					...
					value: function(t, n) {
						...
						return l
							? (r && (l.top += r.top, l.left += r.left), o && (l.top = vt(0, l.top - w(o).height)), l)
							: null
					}
				}, {
					...
					value: function(t) {
						...
						if (!this.isSSR) {
							...
							this.tween.run(a.left, a.top, {
								...
								complete: function() {
									null != u && u !== _t.location.hash && n.updateURLHash(u, r.updateURL),
					...
					value: function() {
						var t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
						this.isSSR || (this.container
							? (this._stopScrollListener && (this._shouldCallCancelScroll = !0), this.tween.stop(t))
					...
					value: function() {
						var t = arguments.length > 0 && void 0 !== arguments[0]
							...
							: {};
						this.container
							? (this.stop(), this.unbindContainerClick(), this.unbindContainerStop(), this.options = c({}, this.options, t), this.header = p(this.options.header), this.bindContainerClick())
					...
					value: function() {
						this.container
							? (this.stop(), this.unbindContainerClick(), this.unbindContainerStop(), this.container = null, this.header = null, this.tween = null)
							: this.isSSR || this.log("Not found scrollable container.")
					}
				}, {
					key: "beforeScroll",
					...
					value: function(t) {
						...
						return i.top = parseInt(i.top, 10),
					...
					key: "updateURLHash",
					value: function(t, n) {
						!this.isSSR && It && n && _t.history["replace" === n
								? "replaceState"
								: "pushState"](null, null, t)
					}
				}, {
					key: "getContainer",
					value: function(t) {
					...
					value: function() {
						var t = this.container;
						t && (this._stopScrollListener = this.handleStopScroll.bind(this), E(t, Qt, this._stopScrollListener))
					}
				}, {
					key: "unbindContainerStop",
					value: function() {
						var t = this.container;
						t && this._stopScrollListener && (A(t, Qt, this._stopScrollListener), this._stopScrollListener = null)
					}
				}, {
					key: "hook",
					value: function(t, n) {
						for (var e = t[n], o = arguments.length, r = Array(o > 2
							? o - 2
							: 0), l = 2; l < o; l++)
							r[l - 2] = arguments[l];
						if (i(e)) {
